...
function enableExpression(expressionClass) {
	expressionClass.prototype.getI18nText = function(key, replacementTokens) {
		...
		return getText(this._blockContext._runtime, currentLocaleId, key, replacementTokens)
	}
}
...
i18nExpression.prototype.execute = function() {
	...
	this.runInput({
		_resultCallback: function(replacementTokens) {
			self.setResult(self.getI18nText(hintVal, replacementTokens))
		}
	}) // Input
}
...
var priestModule = priest.enableModule(module,
	function(runtime) {
